...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/40 backdrop-blur-[2px]">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <img
          ...
          alt="background"
          className="w-full h-full object-cover blur-[25px] opacity-[0.3] scale-110"
        />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="relative bg-white/70 backdrop-blur-md rounded-3xl shadow-xl shadow-slate-200/40 border border-white/40 overflow-hidden transition-all">
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
            <img
              ...
              alt="room list bg"
              className="w-full h-full object-cover blur-[35px] opacity-[0.18] scale-125"
            />
          </div>
